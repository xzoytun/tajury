...
async function sendMainMenu(ctx) {
  ...
  // --- LOGIKA BARU UNTUK WAKTU & TANGGAL ---
  const now = new Date();
  ...
  // Format tampilan
  const namaStore = escapeHtml(NAMA_STORE || 'PREMIUM STORE');
...
<blockquote>• Status : ${roleLabel}
• ID Anda : ${userId}
• Saldo Anda : Rp ${saldoFormatted}
• Total Transaksi : ${totalAkunDibuat} Proses
• Total User Bot : ${totalUserBot}</blockquote>
━━━━━━━━━━━━━━━━━━━━━━━━━━━
📋 <b>Menu Tersedia</b>
...
function generateServiceMenu(action) {
  ...
  if (action === 'create') {
    teks = `━━━━━━━━━━━━━━━━━━━━━━━━━━━
    <b>🚀 PEMBUATAN AKUN VPN</b>
━━━━━━━━━━━━━━━━━━━━━━━━━━━
<blockquote>⚡ <b>Keunggulan Layanan</b>
• Kinerja tinggi & stabil maksimal
• Perlindungan optimal
• Proses otomatis & cepat
• Langsung aktif setelah dibuat
• Tanpa konfigurasi tambahan</blockquote>
━━━━━━━━━━━━━━━━━━━━━━━━━━━

<b>📡 Pilih Protokol VPN</b>

<i>Silakan pilih protokol yang ingin Anda gunakan:</i>`;
    ...
    keyboard = [
      ...
      [
        { text: '💎 ZIVPN Premium', callback_data: 'create_zivpn' }
      ],
      [
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━
<blockquote>✅ <b>Benefit Perpanjangan</b>
• Masa aktif diperbarui otomatis
• Tanpa konfigurasi ulang
• Koneksi tetap stabil
• Proses instant & cepat
• Data akun tetap sama</blockquote>
━━━━━━━━━━━━━━━━━━━━━━━━━━━

<b>📡 Pilih Akun yang Diperpanjang</b>

<i>Pilih protokol akun Anda:</i>`;
    ...
    keyboard = [
      ...
      [
        { text: '💎 ZIVPN Premium', callback_data: 'renew_zivpn' }
      ],
      [
        { text: '🏠 Kembali ke Menu Utama', callback_data: 'send_main_menu' }
      ]
    ...
    teks = `━━━━━━━━━━━━━━━━━━━━━━━━━━━
    <b>🎁 AKUN TRIAL GRATIS</b>
━━━━━━━━━━━━━━━━━━━━━━━━━━━
<blockquote>⏱️ <b>Detail Trial</b>
• Durasi : 60 menit
• Biaya : Gratis 100%
• Aktivasi : Otomatis
• Akses : Full fitur premium
• Testing : Kecepatan & stabilitas</blockquote>
━━━━━━━━━━━━━━━━━━━━━━━━━━━

<b>📡 Pilih Layanan Trial</b>

<i>Coba langsung kualitas layanan kami:</i>`;
    ...
    keyboard = [
      ...
      [
        ...
        { text: '🛡️ TROJAN', callback_data: 'trial_trojan' }
      ],
      [
        { text: '💎 ZIVPN', callback_data: 'trial_zivpn' }
      ],
      [
        { text: '🏠 Kembali ke Menu Utama', callback_data: 'send_main_menu' }
      ]
...
async function showTrialServerMenu(ctx, jenis) {
  try {
    ...
    keyboard.push([{ text: 'Kembali ke Pilihan Protokol', callback_data: 'service_trial' }]);
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━
<blockquote>📅 ${escapeHtml(dateStr)}
🕐 ${escapeHtml(timeStr)}</blockquote>
━━━━━━━━━━━━━━━━━━━━━━━━━━━
<b>⚙️ Menu Kontrol</b>
<blockquote>• <b>Menu Server</b>
  Kelola server & konfigurasi hosting
• <b>Menu Sistem</b>
  Pengaturan sistem & layanan bot
• <b>Full Control</b>
  Akses penuh untuk administrasi</blockquote>
━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  const keyboardServer = {
    inline_keyboard: [
      ...
      [
        ...
        { text: '⚠️ Batas Create', callback_data: 'editserver_batas_create_akun' }
      ],
      [
...
<blockquote>• <b>Tambah/Hapus Server</b>
  Kelola server dalam sistem
• <b>Edit Konfigurasi</b>
  Ubah harga, nama, domain, auth, quota, limit IP
• <b>Manajemen Saldo User</b>
  Tambah atau kurangi saldo pengguna
• <b>Monitoring</b>
  Detail server, batas & total create, list server
• <b>Reset Database</b>
  Reset konfigurasi server</blockquote>
━━━━━━━━━━━━━━━━━━━━━━━━━━━

<i>Pilih menu untuk melanjutkan</i>
`.trim();
...
<blockquote>• <b>Statistik & Pengguna</b>
  Lihat statistik global dan list pengguna
• <b>Broadcast & Database</b>
  Kirim broadcast, backup & restore database
• <b>Manajemen Reseller</b>
  Promote, downgrade, ubah level reseller
• <b>Reset & Logging</b>
  Reset komisi, reset trial, log topup</blockquote>
━━━━━━━━━━━━━━━━━━━━━━━━━━━
